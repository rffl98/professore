...
class Project {
    ...
    onProjectSelected(event) {
        ...
        const project = el.dataset.id;

        // generate a new (custom) event to warn App.js of the change
        document.dispatchEvent(new CustomEvent('filter-selected', {detail: {tasks: this.taskManager.getByProject(project), title: project + ' - Tutti'}}));
    }
}
